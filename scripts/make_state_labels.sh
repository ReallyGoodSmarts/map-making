...
npx mapshaper -i geos/us_states_albers.json \
    ...
    -style class="g-state-name" \
    -each 'ID_BUILDER=`g-state-${STUSPS}`' \
    -o id-field=ID_BUILDER svgs/us_states_albers_labels_postal.svg
...
npx mapshaper -i geos/us_states_albers.json \
    ...
    -style class="g-state-name" \
    -each 'ID_BUILDER=`g-state-${STUSPS}`' \
    -o id-field=ID_BUILDER svgs/us_states_albers_labels_fullnames.svg
...
npx mapshaper -i geos/us_states_albers.json \
    ...
    -style class="g-state-name" \
    -each 'ID_BUILDER=`g-state-${STUSPS}`' \
    -o id-field=ID_BUILDER svgs/us_states_albers_labels_nyt.svg